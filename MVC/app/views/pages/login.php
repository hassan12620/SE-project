    ...
    <div class="container">
            <div class="row py-5 mt-4 align-items-center">
                ...
                <form  method="Post" action="">
                        ...
                        <!-- Already Registered -->
                        <div class="text-center w-100">
                            <p class="text-muted font-weight-bold">Do not have an account? <a href="/seProjectPractice/MVC/public/auth/signUp" id="register" class="text-primary ml-2">Register</a></p>
                        </div>
                    </form>
                </div>
            </div>
