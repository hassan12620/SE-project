    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 bg-light">
                ...
                <h1 style="text-color:black;">Add Time Slots</h1>
                </div>
                <div class="container">
                                ...
                                <div class="card-body">
                                    <form class="row g-3" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="Day" class="form-control" id="inputCity">
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="">
                                            <button class="btn btn-primary" name="submit" type="submit" style = "width: 150px; height: 50px; margin-top:20px;"   onClick='showMessage()'>Add</button>
