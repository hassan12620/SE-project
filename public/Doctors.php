...
<body>
  ...
  <div class="card">
    <img style="height:500px;"src="images/Doc1.png" class="card-img-top" alt="...">
    <div class="card-body">
  ...
  <div class="card">
    <img style= "height:500px;" src="images/Doc2.png" class="card-img-top" alt="...">
    <div class="card-body">
  ...
  <div class="card">
    <img style= "height:500px;" src="images/Doc3.png" class="card-img-top" alt="...">
    <div class="card-body">
      <h5 class="card-title">Sara Fawzy</h5>
      <p3> Cosmetlogoy</p3>
      <p class="card-text">This card has supporting text below as a natural lead-in to additional content.</p>
      <hr>
      <p>  <i class="bi bi-envelope"></i>
